...
# Configurações
st.set_page_config(page_title="The Last of Us I", layout="centered")
...
# Modo história
cap = capitulos[cidade_index]
st.markdown("---")
st.subheader(f"📖 Capítulo {cidade_index+1}: {cap['cidade']}")
st.markdown(f"<p style='color:white; font-size: 18px'>{cap['historia']}</p>", unsafe_allow_html=True)
